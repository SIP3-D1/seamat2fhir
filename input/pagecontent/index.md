...
<br>
<span style="color: red; font-size: 120%;">このページは心電図検査レポートについて記述している。心臓カテーテル検査レポートについては、暫定的に [こちら](ccs.html)に記述している。</span>
...
#### 心臓カテーテル検査レポートの記述仕様
心臓カテーテル検査レポートについては、[こちらのページ](ccs.html)を参照のこと。
