### 表26 Compositionリソースの仕様（心エコー検査レポート）
...
|  | value |  | 1..1 | string | "1234567890_20231205_LJCS-200D_20231205101112.94.1<BR>4239.1002_20231205112233_200_1" | /CD/id/@extension | 文書ID。値は例示。 |
...
|  |  | code | 1..1 | code | "12132-7" | /CD/code/@code | 文書区分コード。固定値 |
|  |  | display | 0..1 | string | "US Report" | /CD/code/@displayName | 文書区分コードの表示名。 |
...
|  |  | code | 1..1 | code | "12132-7" | /CD/code/@code | 文書カテゴリコード。固定値 |
|  |  | display | 0..1 | string | "US Report" | /CD/code/@displayName | コードの表示名 |
...
| title |  |  | 1..1 | string | "心エコー検査レポート" | /CD/title | この文書の（人が読める）タイトル。固定値。 |
