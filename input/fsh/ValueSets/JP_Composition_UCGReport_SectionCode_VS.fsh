ValueSet: JP_Composition_UCGReport_SectionCode_VS
Id: jp-composition-ucgreport-sectioncode-vs
Title: "SEAMAT UCG Report Section Code ValueSet"
Description: "SEAMAT心エコー検査レポートセクションコード値セット"
* ^url = $JP_Composition_UCGReport_SectionCode_VS
* ^status = #active
* ^experimental = false
* ^date = "2024-05-16"
