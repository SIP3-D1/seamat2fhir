Invariant: practitioner-authenticator-metaprofile
Description: "meta.profileには、指定したプロファイルのURLの記述が存在しなければならない。"
Severity: #error
Expression: "meta.profile.where($this = 'http://jpfhir.jp/fhir/SEAMAT/StructureDefinition/JP_Practitioner_SEAMAT_Authenticator').exists()"

// ==============================
//   Profile 定義
// ==============================
Profile: JP_Practitioner_SEAMAT_Authenticator
Parent: JP_Practitioner
Id: jp-practitioner-seamat-authenticator
Title: "SEAMAT Common Authenticator Practitioner Profile"
Description: "このプロファイルはPractitionerリソースに対して、SEAMAT共通の文書内容責任者のデータを送受信するための基礎となる制約と拡張を定めたものである。"
* ^url = $JP_Practitioner_SEAMAT_Authenticator
* ^status = #active
* ^date = "2023-11-13"
...
* obeys practitioner-authenticator-metaprofile
...
【CDA項目】/ClinicalDocument/authenticator/assignedEntity/assignedPerson/name"
...
【CDA項目】/ClinicalDocument/authenticator/assignedEntity/telecom"
...
【CDA項目】/ClinicalDocument/authenticator/assignedEntity/addr"
/*
* gender ..0
* birthDate ..0
* photo ..0
